...
Занимаюсь разработкой и оптимизацией пайплайнов обработки данных. Строю надежные и масштабируемые ETL/ELT-процессы, обеспечивающие бизнес качественными данными для аналитики и машинного обучения. Готов к сотрудничеству.
